...
function make_main_game_state(game)
{
   ...
   var empty6;
    ...
    function create ()
    {
        ...
        spot2text = this.add.text(25*1.5,90*1.5,'Unlock at \nFloor 10', {fontSize: '15px',fill:'#fff'});
        empty2 = this.add.sprite(50*1.5,100*1.5,'empty').setScale(.1*1.5);
        spot2 = this.add.sprite(50*1.5,100*1.5,'defender').setScale(.1*1.5);
        spot2.setVisible(false);
        spot2.health = 0;
        spot2.maxhealth = 0;
        spot2health = this.add.text(20*1.5,135*1.5,'HP: ' + spot2.health + '/ '+ spot2.maxhealth, {fontSize: '16px',fill:'#000'});
        spot2.alive = 0;
        
        empty1 = this.add.sprite(125*1.5,100*1.5,'empty').setScale(.1*1.5);
        spot1 = this.add.sprite(125*1.5,100*1.5,'attacker').setScale(.1*1.5);
        spot1.setVisible(false);
        spot1.alive = 0;
        spot1.health = 0;
        spot1.maxhealth = 0;
        spot1health = this.add.text(95*1.5,135*1.5,'HP: ' + spot1.health + '/ '+ spot1.maxhealth, {fontSize: '16px',fill:'#000'});

        spot4text = this.add.text(25*1.5,190*1.5,'Unlock at \nFloor 15', {fontSize: '15px',fill:'#fff'});
        empty4 = this.add.sprite(50*1.5,200*1.5,'empty').setScale(.1*1.5);
        spot4 = this.add.sprite(50*1.5,200*1.5,'healer').setScale(.1*1.5);
        spot4.setVisible(false);
        spot4.alive = 0;
        spot4.health = 0;
        spot4.maxhealth = 0;
        spot4health = this.add.text(20*1.5,235*1.5,'HP: ' + spot4.health + '/ '+ spot4.maxhealth, {fontSize: '16px',fill:'#000'});

        spot3text = this.add.text(100*1.5,190*1.5,'Unlock at \nFloor 2', {fontSize: '15px',fill:'#fff'});
        empty3 = this.add.sprite(125*1.5,200*1.5,'empty').setScale(.1*1.5);
        spot3 = this.add.sprite(125*1.5,200*1.5,'attacker').setScale(.1*1.5);
        spot3.setVisible(false);
        spot3.alive = 0;
        spot3.health = 0;
        spot3.maxhealth = 0;
        spot3health = this.add.text(95*1.5,235*1.5,'HP: ' + spot3.health + '/ '+ spot3.maxhealth, {fontSize: '16px',fill:'#000'});

        spot6text = this.add.text(25*1.5,290*1.5,'Unlock at \nFloor 25', {fontSize: '15px',fill:'#fff'});
        empty6 = this.add.sprite(50*1.5,300*1.5,'empty').setScale(.1*1.5);
        spot6 = this.add.sprite(50*1.5,300*1.5,'defender').setScale(.1*1.5);
        spot6.setVisible(false);
        spot6.alive = 0;
        spot6.health = 0;
        spot6.maxhealth = 0;
        spot6health = this.add.text(20*1.5,335*1.5,'HP: ' + spot6.health + '/ '+ spot6.maxhealth, {fontSize: '16px',fill:'#000'});
        
        spot5text = this.add.text(100*1.5,290*1.5,'Unlock at \nFloor 5', {fontSize: '15px',fill:'#fff'});
        empty5 = this.add.sprite(125*1.5,300*1.5,'empty').setScale(.1*1.5);
        spot5 = this.add.sprite(125*1.5,300*1.5,'attacker').setScale(.1*1.5);
        spot5.setVisible(false);
        spot5.alive = 0;
        spot5.health = 0;
        spot5.maxhealth = 0;
        spot5health = this.add.text(95*1.5,335*1.5,'HP: ' + spot5.health + '/ '+ spot5.maxhealth, {fontSize: '16px',fill:'#000'});
        ...
        enemy2 = this.add.sprite(350*1.50,100*1.5,'goblin').setScale(.1*1.5);
        enemy2.attack = floor * 5;
        enemy2.health = floor *10;
        enemy2.alive = 0;
        enemy1 = this.add.sprite(275*1.5,100*1.5,'goblin').setScale(.1*1.5);
        enemy1.attack = floor * 5;
        enemy1.health = floor *10;
        enemy1.alive = 0;
        enemy4 = this.add.sprite(350*1.5,200*1.5,'goblin').setScale(.1*1.5);
        enemy4.attack = floor * 5;
        enemy4.health = floor *10;
        enemy4.alive = 0;
        enemy3 = this.add.sprite(275*1.5,200*1.5,'goblin').setScale(.1*1.5);
        enemy3.attack = floor * 5;
        enemy3.health = floor *10;
        enemy3.alive = 0;
        enemy6 = this.add.sprite(350*1.5,300*1.5,'goblin').setScale(.1*1.5);
        enemy6.attack = floor * 5;
        enemy6.health = floor *10;
        enemy6.alive = 0;
        enemy5 = this.add.sprite(275*1.5,300*1.5,'goblin').setScale(.1*1.5);
